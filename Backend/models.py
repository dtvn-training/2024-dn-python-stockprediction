...
class StockPrediction(db.Model):
    ...
    stockid = db.Column(db.String(50), db.ForeignKey(
        'stocklist.stockid'), nullable=False)
    ...
    stock = db.relationship('StockList', back_populates='predictions',
                            lazy=True, primaryjoin="StockPrediction.stockid == StockList.stockid")
